...
export function HeaderDashboard() {
  ...
  return (
    <header
      className="mb-8 mt-[10%] lg:mt-0 flex flex-col gap-4 rounded-lg
     px-4 lg:flex-row lg:items-center lg:justify-between"
    >
      <div>
        <h2
          className="font-(family-name:--font-volkhov) text-base font-bold
         text-[var(--custom-blue-900)] lg:text-2xl"
        >
