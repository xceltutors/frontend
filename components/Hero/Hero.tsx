...
export function Hero() {
  return (
    <section className="w-full mx-auto flex flex-col-reverse lg:flex-row items-center justify-between px-[1rem] py-[1rem] gap-8 lg:gap-0 h-auto lg:h-[35rem]">
      <div className="w-full lg:w-[35%] h-auto  flex flex-col items-center space-y-4 order-2 lg:order-1 text-center lg:text-left ml-0 md:ml-[2rem]">
      ...
      <div className="w-full lg:w-[68%] h-auto flex flex-col items-center justify-center order-1 lg:order-2">
        <Image
          width={444}
          height={467}
