        ...
        <DefaultLayout>
            <section className="w-full h-auto mx-auto flex items-center flex-col justify-center text-center space-y-6">
                ...
                <p className="w-[70%] md:w-[50%] text-[var(--custom-blue-50)] text-base md:text-2xl">
                    ...
                    While you make money, you also will gain CV-boosting skills, and get that warm fuzzy
            ...
            <section
                className="w-full h-auto lg:h-[33.75rem] flex flex-col gap-8 py-4 sm:py-6
            ...
            >
                ...
                <h2 className="font-(family-name:--font-volkhov) text-[2.35rem] md:text-[3.125rem]
