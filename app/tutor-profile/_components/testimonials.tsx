...
export default function TestimonialsSection({ testimonials }: TestimonialsProps) {
    ...
    if (testimonials.length === 0) {
        return (
            <div className="mb-8">
                <h2 className="text-xl md:text-2xl font-semibold mb-2 text-center">Students testimonials</h2>
                <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-3">
                        <button
                            className="bg-[var(--custom-orange-500)] text-white px-20 py-2.5 
                            ...
                            {testimonials.map((_, index) => (
                                <button
                                    ...
                                    className={`w-2 h-2 rounded-full mx-1 ${index === activeIndex ?
                                        "bg-[var(--custom-orange-500)]" : "bg-gray-300"}`}
