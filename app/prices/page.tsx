    ...
    return (
        <DefaultLayout>
            ...
            lg:order-1 text-center lg:text-left ml-0 md:ml-[2rem]">
                    <h2 className="font-(family-name:--font-volkhov) text-[var(--custom-blue-900)] font-bold
                text-[2.5rem] text-center sm:text-4xl lg:text-[3rem] leading-tight">
                        Set up free meetings
                        before you book
                    </h2>
                    <p className="max-w-[90%] text-[var(--custom-gray-800)] text-base 
                    sm:text-[1.25rem] text-center break-words">
                        When you find a tutor you like, you can <b>book a free 15-minute meeting to ask questions</b>,
                        find out about their teaching style - and make sure they are someone you will get on with!
                    </p>
                    <Image
                        width={430.18}
                        height={85.75}
