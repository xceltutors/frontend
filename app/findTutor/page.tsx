        ...
        <div className="mb-10">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative w-full md:w-[35%]">
              ...
              >
                <option value="" className="text-[#949494]">Subject</option>
            ...
            <button
              ...
              className="flex items-center text-[var(--custom-blue-900)] 
                font-medium ml-[4%] underline cursor-pointer"
            >
              More filters
              <ChevronDown
          ...
          {showMoreFilters && (
            <div className="mt-[2%] relative w-full md:w-[35%]">
            <select
              value={level}
              onChange={(e) => setLevel(e.target.value)}
              className="w-full p-2 border border-[#9F9F9F80] rounded-md appearance-none
            ...
            >
              ...
              <option value="gcse">40$</option>
              <option value="a-level">50$</option>
              <option value="university">60$</option>
            </select>
            <ChevronDown className="absolute right-3 top-3 w-4 h-4 text-gray-500" />
          </div>
          )}
